...
<head>
    ...
    <title>Schotella | <?= $url->getSegment(3) ?> </title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="<?php echo base_url('antrian'); ?>">
                        <img src="public\images\No BG.PNG" class="img-fluid" alt="Brand Logo" style="max-width: 100%; height: auto;">
                    </a>
                    <a class="navbar-brand brand-logo-mini" href="<?php echo base_url('antrian'); ?>">
                        <img src="public\images\No BG.PNG" class="img-fluid" alt="Brand Logo medium" style="max-width: 100%; height: auto;">
                    </a>
                </div>
            </div>
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Schotella © 2023. All rights reserved.</span>
                    </div>
                </footer>
            </div>
            <!-- partial -->
